...
`,H=()=>{const{blogId:t}=b(),[e,n]=f.useState(null),r=O();f.useEffect(()=>{(async()=>{try{const c=await r(v(t));n(c.payload)}catch(c){console.log(c)}})()},[r,t]);const a=s=>{r(j(s)),E.Notify.failure("Пост видалено")};return e?o.jsxs(o.Fragment,{children:[o.jsx(m,{to:{pathname:"/home"},children:o.jsx(_,{type:"button",children:"Повернутися"})}),o.jsxs(B,{title:e.name,children:[o.jsxs(x,{children:["Опис:",e.about]}),o.jsxs(x,{children:["Телефон:",e.phone]}),o.jsx(m,{to:{pathname:"/home"},children:o.jsx(N,{type:"button",size:24,onClick:()=>a(e.id)})})]},e.id)]}):o.jsx(w,{})};export{H as default};
